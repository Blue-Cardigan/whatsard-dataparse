...
import { processXML as processCommonsXML } from './localparse/commons.js';
...
import { generateExtracts } from './extracts.js';
...
async function storeDataInSupabase(debates, debateType) {
  ...
  console.log(`adjustedDebates: ${adjustedDebates.length}`);
  ...
  console.log(`validDebates: ${validDebates.length}`);
  ...
  console.log(`cleanedDebates: ${cleanedDebates.length}`);
  // Generate extracts
